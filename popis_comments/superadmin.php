...
// proveravamo da li je korisnik superadmin,
// ukoliko nije, bice vracen na index.php
...
// uzimamo ukupan broj popisanih
$sql = "SELECT COUNT(id) AS count FROM popisani";

// na pocetku deklarisemo da je on 0
$brojPopisanih = 0;

// sada $brojPopisanih dobija vrednost kolika je iz baze
